...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Waist Strap — The Adjustable Waist Wrap" },
      { name: "description", content: "Waist Strap is an adjustable wrap waist trainer — no hooks, no zippers. One size wraps to your exact waist. Free shipping on 2+, 60-day fit guarantee." },
      { property: "og:title", content: "Waist Strap — The Adjustable Waist Wrap" },
      { name: "twitter:title", content: "Waist Strap — The Adjustable Waist Wrap" },
      ...
      { property: "og:site_name", content: "Waist Strap" },
