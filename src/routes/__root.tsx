...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium dietary supplements formulated to support focus, mental clarity, and all-day energy." },
      ...
      { property: "og:description", content: "Premium dietary supplements formulated to support focus, mental clarity, and all-day energy." },
      { name: "twitter:description", content: "Premium dietary supplements formulated to support focus, mental clarity, and all-day energy." },
