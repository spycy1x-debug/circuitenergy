...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "NOURISH™ settles digestion and puts back the nutrients smaller portions leave behind. Free US shipping, ships in 24 hours, 60-day money-back guarantee." },
      { property: "og:title", content: "Seralie — NOURISH™ Digestive Support + Daily Essentials" },
      { name: "twitter:title", content: "Seralie — NOURISH™ Digestive Support + Daily Essentials" },
      { property: "og:description", content: "One capsule that settles digestion and covers the everyday nutrient gaps." },
      { name: "twitter:description", content: "One capsule that settles digestion and covers the everyday nutrient gaps." },
  ...
  return (
    <html lang="en">
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?n.callMethod.apply(n,arguments):n.queue.push(arguments)};if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version='2.0';n.queue=[];t=b.createElement(e);t.async=!0;t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}(window, document,'script','https://connect.facebook.net/en_US/fbevents.js');fbq('init', '2241686346674827');fbq('track', 'PageView');`,
          }}
        />
        {!hideKlaviyo && (
          <>
      ...
      <body>
        <noscript>
          <img height="1" width="1" style={{ display: 'none' }} src="https://www.facebook.com/tr?id=2241686346674827&ev=PageView&noscript=1" />
        </noscript>
        {children}<Scripts />
      </body>
    </html>
