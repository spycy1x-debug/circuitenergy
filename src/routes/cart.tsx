...
export const Route = createFileRoute("/cart")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Review your Seralie SilkBrush™ order before checkout. Free shipping on all orders and a 365-day money-back guarantee." },
    ...
    <SilkShell>
      <section className="mx-auto max-w-3xl px-5 py-20 text-center md:px-8 md:py-28">
        ...
        <p style={sans} className="mx-auto mt-5 max-w-md text-[15px] leading-8 text-[color:var(--cw-muted)]">
          Free shipping on all orders and 365 days to change your mind.
        </p>
        <Link
          to="/"
          style={sans}
