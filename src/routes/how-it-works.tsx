...
export const Route = createFileRoute("/how-it-works")({
  head: () => ({
    meta: [
      { title: "How WaistWrap™ Works — Wrap, Press, Go" },
      { name: "description", content: "How the WaistWrap™ adjustable waist wrap works: set the tab, wrap firm, press the panel. Fifteen seconds to a snatched waist that holds all day." },
      { property: "og:title", content: "How WaistWrap™ Works" },
...
function HowItWorks() {
  return (
    <WWProse
      ...
      intro="WaistWrap™ is one long compression band. You wrap it, you set the tension, and it holds the shape you chose — no hooks to snap, no zipper to fight, no size chart to get wrong."
      sections={[
