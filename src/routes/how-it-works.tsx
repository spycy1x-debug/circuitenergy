...
export const Route = createFileRoute("/how-it-works")({
  head: () => ({
    meta: [
      { title: "How WaistSnatch™ Works — Wrap, Press, Go" },
      { name: "description", content: "How the WaistSnatch™ adjustable WaistSnatch™ works: set the tab, wrap firm, press the panel. Fifteen seconds to a snatched waist that holds all day." },
      { property: "og:title", content: "How WaistSnatch™ Works" },
...
function HowItWorks() {
  return (
    <WWProse
      ...
      intro="WaistSnatch™ is one long compression band. You wrap it, you set the tension, and it holds the shape you chose — no hooks to snap, no zipper to fight, no size chart to get wrong."
      sections={[
