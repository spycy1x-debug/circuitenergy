...
export const Route = createFileRoute("/how-it-works")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How the SilkBrush™ and its premium handmade Korean silk-bristles smooth frizz and distribute natural oils for a shinier finish." },
...
function HowItWorks() {
  return (
    <WWProse
      ...
      intro="The SilkBrush™ uses premium handmade Korean silk-bristles to smooth the hair's surface while distributing your hair's natural oils through the lengths."
      sections={[
        ...
        { h: "Why the bristles matter", p: <p>The premium handmade Korean silk-bristles help distribute natural oils from the scalp through the lengths while smoothing the hair surface, helping hair appear shinier and more polished.</p> },
