...
export const Route = createFileRoute("/how-it-works")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How the Seralie SilkBrush™ works: brush dry hair in small sections and the Korean silk bristles help smooth frizz and distribute natural oils for a shinier, straighter-looking finish." },
...
function HowItWorks() {
  return (
    <WWProse
      ...
      intro="The SilkBrush™ is a premium handmade Korean silk-bristle brush designed to smooth the hair's surface while distributing your hair's natural oils through the lengths."
      sections={[
        ...
        { h: "Why silk bristles", p: <p>The Korean silk bristles help distribute natural oils from the scalp through the lengths of the hair while smoothing the hair surface, helping hair appear shinier and more polished.</p> },
