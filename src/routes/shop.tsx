...
export const Route = createFileRoute("/shop")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Shop the Seralie SilkBrush™ — a premium handmade Korean silk-bristle brush for smoother, shinier, straighter-looking hair. $37.99 with free shipping on all orders." },
        ...
        <div className="mt-10 max-w-sm">
          <Link to="/silkbrush" className="group block">
            ...
            <p style={sans} className="mt-1 text-[13px] text-[color:var(--cw-muted)]">
              Korean silk-bristle smoothing brush · $37.99
            </p>
