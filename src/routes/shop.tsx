...
export const Route = createFileRoute("/shop")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Shop the Seralie SilkBrush™ — a boar-bristle brush for smoother, shinier, straighter-looking hair. $37.99 with free shipping on all orders." },
