...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Answers about the Seralie SilkBrush™ premium handmade Korean silk-bristle brush: how it works, hair types, care, shipping and our 365-day money-back guarantee." },
