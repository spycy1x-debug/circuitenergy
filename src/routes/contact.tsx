...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Questions about your order, the SilkBrush™, or our 365-day money-back guarantee? Email support@seralie.com — we reply within 24 hours." },
