  ...
  head: () => ({
    ...
    meta: [
      { title: "Seralie SilkBrush™ — Smooth. Straighten. Shine." },
      {
        name: "description",
        content:
          "The Seralie SilkBrush™ uses premium handmade Korean silk-bristles to smooth frizz and create a sleek, straighter-looking finish. Choose bamboo or plastic.",
      },
