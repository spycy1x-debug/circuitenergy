  ...
  head: () => ({
    ...
    meta: [
      { title: "Seralie SilkBrush™ — Smooth. Straighten. Shine." },
      {
        name: "description",
        content:
          "The Seralie SilkBrush™ is designed to smooth frizz and create a sleek, straighter-looking finish while you brush. Choose bamboo or plastic. Free shipping on all orders, 365-day money-back guarantee.",
      },
