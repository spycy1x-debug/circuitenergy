  ...
  head: () => ({
    ...
    meta: [
      { title: "Seralie SilkBrush™ — Smooth. Straighten. Shine." },
      {
        name: "description",
        content:
          "The Seralie SilkBrush™ is a premium handmade Korean silk-bristle brush designed to smooth frizz and create a sleek, straighter-looking finish while you brush. Choose bamboo or plastic. Free shipping on all orders, 365-day money-back guarantee.",
      },
      { property: "og:title", content: "Seralie SilkBrush™ — Smooth. Straighten. Shine." },
      {
        property: "og:description",
        content: "Premium handmade Korean silk-bristle brush for smoother, shinier, straighter-looking hair. Free shipping on all orders. 365-day money-back guarantee.",
      },
