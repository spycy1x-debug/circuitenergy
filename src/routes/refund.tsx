...
export const Route = createFileRoute("/refund")({
  head: () => ({
    meta: [
      { title: "Refund Policy — SilkBrush™" },
      { name: "description", content: "SilkBrush™ is covered by a 60-day fit guarantee. Here is exactly how returns and refunds work." },
      { property: "og:title", content: "Refund Policy — SilkBrush™" },
  ...
  component: () => (
    <WWProse
      ...
      intro="Wear it. Wash it. Live in it. If SilkBrush™ isn't right, we refund the product price."
      sections={[
