...
export const Route = createFileRoute("/refund")({
  head: () => ({
    meta: [
      { title: "Refund Policy — WaistWrap™" },
      { name: "description", content: "WaistWrap™ is covered by a 60-day fit guarantee. Here is exactly how returns and refunds work." },
      { property: "og:title", content: "Refund Policy — WaistWrap™" },
  ...
  component: () => (
    <WWProse
      ...
      intro="Wear it. Wash it. Live in it. If WaistWrap™ isn't right, we refund the product price."
      sections={[
        { h: "How it works", p: <p>Email support@waistwrap.com within 60 days of delivery with your order number. Worn wraps are fine — we ask that you actually gave it a fair try.</p> },
