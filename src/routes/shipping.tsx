...
export const Route = createFileRoute("/shipping")({
  head: () => ({
    meta: [
      { title: "Shipping — WaistWrap™" },
      { name: "description", content: "WaistWrap™ ships within 24 hours. Free US shipping on orders of 2+ wraps, $4.95 flat on single wraps, 3–5 business day delivery." },
      { property: "og:title", content: "Shipping — WaistWrap™" },
  ...
  component: () => (
    <WWProse
      ...
      sections={[
        ...
        { h: "Tracking", p: <p>You get a tracking link by email the moment your parcel is scanned. If it hasn't moved in 5 days, email support@waistwrap.com and we'll chase it or reship.</p> },
