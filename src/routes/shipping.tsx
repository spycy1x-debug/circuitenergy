...
export const Route = createFileRoute("/shipping")({
  head: () => ({
    meta: [
      { title: "Shipping — SilkBrush™" },
      { name: "description", content: "SilkBrush™ ships within 24 hours. Free US shipping on orders of 2+ wraps, $4.95 flat on single wraps, 3–5 business day delivery." },
      { property: "og:title", content: "Shipping — SilkBrush™" },
