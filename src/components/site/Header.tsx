    ...
    <>
      ...
      >
        <div className="container-x relative grid h-24 md:h-28 grid-cols-3 items-center">
          ...
          <div className="flex items-center justify-center">
            <Link to="/" aria-label="Seralie home" className="flex items-center justify-center">
              <img src={seralieLogo.url} alt="Seralie" className="h-20 md:h-24 w-auto" />
            </Link>
          </div>
        ...
        {open && (
          <>
            <div
              className="fixed inset-0 top-24 md:top-28 z-30 bg-[#3B2E25]/25"
              ...
              <div className="container-x py-14 grid gap-14 md:grid-cols-[1.2fr_1fr]">
                ...
                <div>
                  ...
                  <div className="mt-6 text-[11px] text-[#7A6A5E] tracking-wide">
                    Complimentary shipping over $75 · 30-day guarantee
                  </div>
                </div>
              </div>
            </nav>
