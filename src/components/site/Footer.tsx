    ...
    <footer className="bg-[#1A1A1A] text-[#CCCCCC]">
      <div className="container-x py-16 grid gap-10 md:grid-cols-3">
        ...
        <div className="grid grid-cols-2 gap-2 text-sm">
          ...
          <Link to="/why-tired" className="py-1 hover:text-white">
            Why You're Tired
          </Link>
          <Link to="/contact" className="py-1 hover:text-white">
            Contact
          </Link>
      ...
      <div className="border-t border-white/10">
        <div className="container-x py-6 text-xs text-[#888] leading-relaxed">
          © 2026 Circuit Energy. All rights reserved. | These statements have not been evaluated by the FDA. This
