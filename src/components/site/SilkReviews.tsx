...
const REVIEW_COPY: Review[] = [
  ...
  { name: "Jordan Q.", rating: 5, date: "May 17, 2026", title: "The bristles make a difference", body: "I am particular about hair products and was pleasantly surprised. The bristles seem to smooth the surface of my hair, leaving it softer and silkier to the touch." },
