...
export const REVIEWS: Review[] = [
  ...
  { id: "r11", name: "Jenna F.", rating: 5, date: "Jul 30, 2026", title: "less bloated by dinner", body: "3 weeks in. the after lunch bloat is basically gone. i dont unbutton my jeans at my desk anymore lol" },
  { id: "r12", name: "Robert H.", rating: 5, date: "Jul 26, 2026", body: "im 58 and just wanted something simple. one pill covers most of what my doc told me to take. no complaints" },
  ...
  { id: "r14", name: "Tyler J.", rating: 5, date: "Jul 22, 2026", body: "gym bro here. iron never sat right with me. this one doesnt make me queasy. thats it thats the review" },
  { id: "r15", name: "Anita R.", rating: 5, date: "Jul 19, 2026", title: "regular. finally.", body: "sorry for tmi but ive struggled with this for years. magnesium in here does something. mornings are predictable now" },
  { id: "r16", name: "Chris D.", rating: 5, date: "Jul 17, 2026", body: "bought for my wife she stole my bottle so now we order 3 at a time" },
  { id: "r17", name: "Paula M.", rating: 5, date: "Jul 14, 2026", title: "no more 4 different bottles", body: "i was taking b12, iron, a probiotic and magnesium separately. cabinet is way cleaner now and its cheaper" },
  ...
  { id: "r21", name: "Hannah T.", rating: 5, date: "Jul 6, 2026", body: "postpartum and running on empty. this helped more than the prenatal i was still taking honestly" },
  ...
  { id: "r29", name: "Ellen V.", rating: 5, date: "Jun 17, 2026", body: "im 67. my afternoons used to be a write off. not anymore. took about two months to really settle in" },
  ...
  { id: "r41", name: "Marta Q.", rating: 5, date: "May 20, 2026", body: "my mom takes it, i take it, we split the 3 pack. both of us notice the digestion difference" },
